...
**Domain:** Pure-userspace iSCSI initiator library in Go
...
```bash
# Initialize module
go mod init github.com/[org]/uiscsi
...
These are reference implementations to learn from, not dependencies.
...
**For unit testing (PDU encoding, negotiation logic, state machines):**
...
**For integration testing (full login, command execution, error recovery):**
...
---
*Stack research for: pure-userspace iSCSI initiator library in Go*
*Researched: 2026-03-31*
